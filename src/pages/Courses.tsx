...
const Courses = () => {
  ...
  const courseData = {
    ...
    "AI": {
      "ChatGPT & OpenAI": [
        { name: "ChatGPT for IT Professionals", isBytes: true },
    ...
    "Bytes": {
      ...
      "Help Desk": [
        { name: "Help Desk: Introduction to Computer Networking", isBytes: true },
        { name: "Help Desk: Understanding Network Infrastructure", isBytes: true },
        { name: "Help Desk: Building Troubleshooting Skills", isBytes: true },
        { name: "Help Desk: Incident Management", isBytes: true },
        { name: "Help Desk: ITIL Foundations", isBytes: true },
      ],
      "Cybersecurity": [
        { name: "Hacking and Securing Cloud Applications", isBytes: true },
        { name: "Security Operations and the SOC", isBytes: true },
        { name: "Vulnerability Management", isBytes: true },
        { name: "Threat Intelligence", isBytes: true },
        { name: "Incident Response Process", isBytes: true },
        { name: "Introduction to Ethical Hacking", isBytes: true },
        { name: "Introduction to Zero Trust", isBytes: true },
        { name: "Cyber Threats and Kill Chains", isBytes: true },
        { name: "Endpoint Security Essentials", isBytes: true },
        { name: "Security Foundations", isBytes: true },
        { name: "Security Awareness", isBytes: true },
        { name: "Physical Security Principles", isBytes: true },
        { name: "Introduction to Identity & Access Management (IAM)", isBytes: true },
        { name: "Data Loss Prevention Strategies", isBytes: true },
        { name: "Introduction to Digital Forensics", isBytes: true },
      ],
    },
  };
