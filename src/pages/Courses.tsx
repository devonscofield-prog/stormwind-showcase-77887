...
const Courses = () => {
  ...
  const courseData = {
    ...
    "Desktop Applications": {
      ...
      "Google Workspace": [
        { name: "Google Classroom Foundations" },
        { name: "Google Docs Beginner" },
        { name: "Google Drive Beginner" },
        { name: "Google Forms Beginner" },
        { name: "Google Meets Foundations" },
        { name: "Google Sheets Beginner" },
        { name: "Google Slides Foundations" },
      ],
    ...
    "Full Stack Developer": {
      ...
      "Projects & Challenges": [
        ...
        { name: "Intro to SQL" },
        { name: "Foundations of Algorithms Masterclass" },
      ],
    },
    "Networking": {
      "Cisco CCNA": [
