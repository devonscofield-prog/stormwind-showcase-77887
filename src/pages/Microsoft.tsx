...
const courses: {
  ...
  // End User — M365 + SharePoint
  {
    ...
    topic: "M365 + SharePoint",
    description:
      "Beginner, Intermediate, and Advanced levels — worksheets and formulas through pivot tables, Power Query, macros, and reporting.",
  },
  {
    code: "M365-WORD",
    title: "Word 365",
    ...
    topic: "M365 + SharePoint",
    description:
      "Beginner, Intermediate, and Advanced levels — document creation and formatting through mail merge, long-document layout, and automation.",
  },
  {
    code: "M365-PPT",
