    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#0f1419]">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 text-center">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <span className="relative inline-block">
              ...
              <span className="relative text-white drop-shadow-2xl">
                ...
                {typedText.length < fullText.length && (
                  <span className="inline-block w-1 h-[0.9em] bg-[#4FD1C5] ml-1 animate-pulse align-middle shadow-[0_0_20px_rgba(79,209,197,0.8)]"></span>
                )}
              </span>
            </span>
          </h1>
          ...
          <p 
            className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto drop-shadow-2xl transition-all duration-1000 delay-300"
            style={{
